...
module.exports = {
   ...
   colorRenderPlan: colorRenderPlan,
   revealTailFrames: revealTailFrames,
   ...
   FFMPEG_MIRROR_BASE: FFMPEG_MIRROR_BASE,
   ffmpegMirrorCandidates: ffmpegMirrorCandidates,
   ffmpegInstalledName: ffmpegInstalledName,
   ffmpegInstallDir: ffmpegInstallDir,
   ffmpegCandidatePaths: ffmpegCandidatePaths,
   shellQuote: shellQuote,
   buildEncodeScriptText: buildEncodeScriptText,
   partialVideoPath: partialVideoPath,
   ...
   makeCameraFromBasis: makeCameraFromBasis,
   cameraProjector: cameraProjector,
   projectVecPre: projectVecPre,
   smootherstep01: smootherstep01,
   ...
   saQualityOk: saQualityOk,
   rescaleAlignment: rescaleAlignment,
   ...
   REVEAL_SEAM_BUDGET_PX: REVEAL_SEAM_BUDGET_PX,
   scaleWcsToDims: scaleWcsToDims,
   scaleWcsCropped: scaleWcsCropped,
   cropWcs: cropWcs,
